    ...
    <section className="w-full bg-white text-gray-800">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 space-y-8 text-center md:text-left">
            <h3 className="text-5xl md:text-6xl font-bold leading-tight text-gray-900">
              Slogan Text from Admin
            </h3>

            <p className="text-lg md:text-xl leading-relaxed text-gray-600 max-w-xl">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
              sollicitudin, nisl eget egestas gravida, lacus leo ornare enim, sed
              gravida lectus libero eu augue. Vivamus volutpat justo nec
              ullamcorper tempor.
            </p>
      ...
      <div className="w-full bg-gray-100 py-16 px-6 md:px-12 rounded-3xl max-w-5xl mx-auto mt-20">
        ...
        <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl">
          ...
          fermentum libero sed sapien dignissim, sit amet laoreet orci egestas.
          Curabitur faucibus, lorem nec placerat feugiat, justo odio interdum
          lectus, sit amet accumsan lorem odio ac erat.
        </p>
      </div>
      <ImpactSection />
    </section>
